...
function conky_draw_text()
    ...
    text_settings={
        {
			text=conky_parse("${execi 60 scripts/vnstat.sh}"),
        ...
        {
			text=conky_parse("${execi 60 sleep 1 && awk 'NR==1' scripts/vnstat.txt}"),
            font_name="arial",
            h_align="r",
			x=140,
			y=70,
        ...
        {
			text=conky_parse("${execi 60 sleep 1 && awk 'NR==2' scripts/vnstat.txt}"),
            font_name="arial",
            h_align="r",
			x=240,
			y=70,
        ...
        {
			text=conky_parse("${execi 60 sleep 1 && awk 'NR==3' scripts/vnstat.txt}"),
            font_name="arial",
            h_align="r",
			x=140,
			y=90,
        ...
        {
			text=conky_parse("${execi 60 sleep 1 && awk 'NR==4' scripts/vnstat.txt}"),
            font_name="arial",
            h_align="r",
			x=240,
			y=90,
        ...
        {
			text=conky_parse("${execi 60 sleep 1 && awk 'NR==5' scripts/vnstat.txt}"),
            font_name="arial",
            h_align="r",
			x=140,
			y=110,
        ...
        {
			text=conky_parse("${execi 60 sleep 1 && awk 'NR==6' scripts/vnstat.txt}"),
            font_name="arial",
            h_align="r",
			x=240,
			y=110,
